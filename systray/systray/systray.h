...
extern "C" {
	...
	__declspec(dllexport) void __cdecl add_or_update_menu_item(int menuId, int menuIdBefore, wchar_t* title, wchar_t* tooltip, short disabled, short checked, short remove, short seperator);
